...
public class GameField {
	...
	public GameField(Block[][] gameArray) {
		...
		try {
			...
			// create image
			arrayAsImage = Image.createOffscreenImage(gameArray.length,
					gameArray[0].length);
	...
	/**
	 * Changes a pixel in the graphic representation of the gamefield
	 * 
	 * @param x
	 * @param y
	 * @param color
	...
	/**
	 * Changes a block in the gamefield as well as his graphic representation
	 * 
	 * @param x
	 * @param y
	 * @param block new block type
	 */
	...
	/** Adds a new Player to the gamefield
	 * @param playerArray Array containing all the relevant informatio for the player
	 */
